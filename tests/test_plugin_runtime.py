...
class PluginRuntimeTests(unittest.TestCase):
    ...
    def test_plugin_status_and_health_use_across_home(self):
        ...
        self.assertTrue(manifest["capabilities"]["sandboxExecution"])
        self.assertTrue(manifest["capabilities"]["sandboxProviderRegistry"])
        self.assertTrue(manifest["capabilities"]["unifiedEvidenceReceipt"])
