...
def render_plugin_manifest(command: str = "across-orchestrator") -> dict:
    return {
        ...
        "entrypoints": {
            ...
            "goalRevalidation": {
                "command": command,
                "args": ["goal-revalidation"],
                "schemaVersion": "across-goal-revalidation-request/1.1",
            },
            "sdk": {
        ...
        "protocols": {
            ...
            "mcp": {
                ...
                "tools": {
                    ...
                    "executeSandboxCommand": "execute_sandbox_command",
                    "listSandboxProviders": "list_sandbox_providers",
                    "evaluateAgentTeamReadiness": "evaluate_agent_team_readiness",
                    "buildEvidenceReceipt": "build_evidence_receipt",
