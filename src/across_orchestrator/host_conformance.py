...
PLUGIN_PROVIDE_CAPABILITIES = {
    ...
    "sandbox_policy_evaluation": "sandboxPolicyEvaluation",
    "sandbox_execution": "sandboxExecution",
    "sandbox_provider_registry": "sandboxProviderRegistry",
    "unified_evidence_receipt": "unifiedEvidenceReceipt",
    "agent_team_readiness": "agentTeamReadiness",
    "remote_mcp_oauth_template": "remoteMcpOAuthTemplate",
    "remote_mcp_resource_server": "remoteMcpResourceServer",
    "mcp_tasks_projection": "mcpTasksProjection",
    "a2a_task_delegation": "a2aTaskDelegation",
    "a2a_task_delegation_v2": "a2aTaskDelegationV2",
    "agui_projection": "aguiProjection",
    "otel_genai_export": "otelGenaiExport",
